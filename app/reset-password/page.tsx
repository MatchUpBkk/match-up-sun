      ...
      <div className="glass w-full max-w-md p-8">
        ...
        {sent ? (
          <div className="mt-8 text-center">
            ...
            <h1 className="mt-6 text-2xl font-extrabold text-white">{t('auth.checkInbox')}</h1>
            <p className="mt-3 text-sm text-white/65">{t('auth.reset.sent')}</p>
          ...
          <>
            <h1 className="mt-8 text-center text-2xl font-extrabold text-white">{t('auth.reset.title')}</h1>
            <p className="mt-2 text-center text-sm text-white/55">{t('auth.reset.subtitle')}</p>
            ...
            <form onSubmit={submit} className="mt-6 space-y-4">
              ...
              <button type="submit" className="btn btn-primary w-full justify-center disabled:opacity-60" disabled={loading}>
                {loading ? '…' : t('auth.reset.cta')} <IconArrow className="h-4 w-4" />
              </button>
            </form>
